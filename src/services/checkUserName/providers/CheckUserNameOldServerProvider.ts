...
export const checkUserNameOldServer = (callback: any, language: string) => {
    const data = {
        content: "<!-- ${message:username-checker-valid} -->"
    };

    console.log(1);
    fetch("https://www.jackpotjoy.ppc2.pgt01.gamesysgames.com/registerstepped.registerblockusername.username:updateusernamezone?_csrf=03275fd1-6ac7-4361-98bc-f28b5cac467f¶m=superthing235", {
